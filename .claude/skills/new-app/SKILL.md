...
**Storage (Prisma models sugeridos):**
- `[tabla1]`: [descripcion]
- `[tabla2]`: [descripcion]
...
```
src/features/
├── auth/           # Autenticacion Email/Password (Auth.js v5)
...
- **Backend:** PostgreSQL (Coolify) + Prisma ORM
- **Auth:** Auth.js v5 (NextAuth)
- **Validacion:** Zod
- **State:** Zustand (si necesario)
- **MCPs:** Next.js DevTools + Playwright + Coolify

### Proximos Pasos
1. [ ] Setup proyecto base
2. [ ] Configurar PostgreSQL (docker compose up -d)
3. [ ] Implementar Auth (Auth.js v5)
4. [ ] Feature: [feature-1]
5. [ ] Feature: [feature-2]
6. [ ] Testing E2E
7. [ ] Deploy Coolify
