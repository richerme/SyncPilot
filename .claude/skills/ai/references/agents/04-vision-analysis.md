...
## Alternativa: Guardar Imagenes Permanentemente

Si quieres guardar las imagenes en el servidor, usa una API route para upload:
...
> **Nota**: Para produccion, considera usar un servicio de almacenamiento externo (S3, Cloudflare R2, etc.) en vez del filesystem local.
