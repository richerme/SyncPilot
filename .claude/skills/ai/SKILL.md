...
Stack: **Vercel AI SDK v5 + OpenRouter (300+ modelos) + Prisma/PostgreSQL**
...
| 03 | **historial** | Persistir conversaciones con Prisma. Historial por usuario |
...
| 06 | **rag** | Retrieval Augmented Generation. Embeddings + busqueda semantica con pgvector |
...
| `historial` | `references/agents/03-historial-prisma.md` |
