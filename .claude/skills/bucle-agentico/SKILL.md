...
- Que modelos existen en `prisma/schema.prisma`?
...
```
Prisma / Codebase:
  - Read prisma/schema.prisma -> Ver que modelos existen
  - Grep/Glob/Read -> Buscar patrones existentes, entender estructura
```
...
Prisma:
  - npx prisma migrate dev -> Crear/modificar tablas
  - npx prisma studio -> Verificar que datos se guardan
```
